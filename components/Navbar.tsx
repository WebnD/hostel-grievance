  ...
  return (
    <header className="flex h-16 w-full shrink-0 items-center px-4 md:px-6 sticky top-0 z-10 bg-white dark:bg-gray-950">
      ...
      <div className="flex w-full lg:w-0 items-center justify-between">
        <Sheet>
          ...
          <SheetContent side="left">
            <SheetHeader>
              <SheetTitle>Grievance IIT BBS</SheetTitle>
            </SheetHeader>
            <Link href="#" className="mr-6 hidden lg:flex" prefetch={false}>
              {/* <MountainIcon className="h-6 w-6" /> */}
              {/* <div className="text-xl bg-red-300">Acme Inc</div> */}
              <span className="sr-only">Grievance IIT BBS</span>
            </Link>
      ...
      >
        ...
        <span className="text-lg font-bold">Grievance IIT BBS | Developed by WebnD</span>
        {/* <Vault IIT BBSLogo /> */}
        {/* <Badge className="mx-2 h-8">BETA</Badge> */}
        <span className="sr-only">Grievance IIT BBS | Developed by WebnD</span>
      </Link>
